...
KERNEL_CMD_NON_TD=""
KERNEL_CMD_TD="root=${ROOT_PARTITION} rw console=hvc0"
MAC_ADDR=""
QUOTE_TYPE=""

# Mount an extra partition
EXTRA_DISK=""
...
process_args() {
    while getopts ":i:k:t:b:p:f:o:a:m:vdshq:c:r:n:" option; do
        case "$option" in
            i) GUEST_IMG=$OPTARG;;
            k) KERNEL=$OPTARG;;
            t) VM_TYPE=$OPTARG;;
